...
var Bling = (_temp2 = _class = function (_Component) {
    ...
    _createClass(Bling, [{
        ...
        value: function foldCheck() {
            ...
            if (this.props.viewableTriggerTop && this.props.viewableTriggerTop > 0) {
                var rect = _reactDom2.default.findDOMNode(this).getBoundingClientRect();
                var triggerPercentVal = window.innerHeight / 100 * this.props.viewableTriggerTop;
                console.log(this.props.id, rect.top, triggerPercentVal, window.innerHeight);
                if (rect.top <= window.innerHeight + triggerPercentVal) {
                    console.log(this.props.id + " triggered");
     ...
     */
    viewableTriggerTop: _propTypes2.default.number,
    /**
